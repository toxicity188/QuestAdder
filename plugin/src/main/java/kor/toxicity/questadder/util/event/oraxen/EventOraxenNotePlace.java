...
public class EventOraxenNotePlace extends AbstractEvent<OraxenNoteBlockPlaceEvent> {
    ...
    private Predicate<OraxenNoteBlockPlaceEvent> predicate = e -> true;

    public EventOraxenNotePlace(QuestAdder adder, AbstractAction action) {
        super(adder, action, OraxenNoteBlockPlaceEvent.class);
    }
    ...
    @Override
    public void invoke(@NotNull OraxenNoteBlockPlaceEvent event) {

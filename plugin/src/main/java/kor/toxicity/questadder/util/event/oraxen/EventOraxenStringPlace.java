...
public class EventOraxenStringPlace extends AbstractEvent<OraxenStringBlockPlaceEvent> {
    ...
    private Predicate<OraxenStringBlockPlaceEvent> predicate = e -> true;

    public EventOraxenStringPlace(QuestAdder adder, AbstractAction action) {
        super(adder, action, OraxenStringBlockPlaceEvent.class);
    }
    ...
    @Override
    public void invoke(@NotNull OraxenStringBlockPlaceEvent event) {

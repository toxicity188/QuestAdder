...
public class EventOraxenFurnitureClick extends AbstractEvent<OraxenFurnitureInteractEvent> {
    ...
    private Predicate<OraxenFurnitureInteractEvent> predicate = e -> true;

    public EventOraxenFurnitureClick(QuestAdder adder, AbstractAction action) {
        super(adder, action, OraxenFurnitureInteractEvent.class);
    }
    ...
    @Override
    protected void invoke(OraxenFurnitureInteractEvent event) {

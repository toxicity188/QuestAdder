...
public class EventOraxenNoteBreak extends AbstractEvent<OraxenNoteBlockBreakEvent> {
    ...
    private Predicate<OraxenNoteBlockBreakEvent> predicate = e -> true;

    public EventOraxenNoteBreak(QuestAdder adder, AbstractAction action) {
        super(adder, action, OraxenNoteBlockBreakEvent.class);
    }
    ...
    @Override
    public void invoke(@NotNull OraxenNoteBlockBreakEvent event) {

...
public class EventOraxenNoteClick extends AbstractEvent<OraxenNoteBlockInteractEvent> {
    ...
    private Predicate<OraxenNoteBlockInteractEvent> predicate = e -> true;

    public EventOraxenNoteClick(QuestAdder adder, AbstractAction action) {
        super(adder, action, OraxenNoteBlockInteractEvent.class);
    }
    ...
    @Override
    public void invoke(@NotNull OraxenNoteBlockInteractEvent event) {

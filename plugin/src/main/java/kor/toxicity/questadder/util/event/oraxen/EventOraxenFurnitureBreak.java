...
public class EventOraxenFurnitureBreak extends AbstractEvent<OraxenFurnitureBreakEvent> {
    ...
    private Predicate<OraxenFurnitureBreakEvent> predicate = e -> true;

    public EventOraxenFurnitureBreak(QuestAdder adder, AbstractAction action) {
        super(adder, action, OraxenFurnitureBreakEvent.class);
    }
    ...
    @Override
    public void invoke(@NotNull OraxenFurnitureBreakEvent event) {
